...
const SummaryCard = ({ title, value, icon, subtext, type = 'primary', onClick, isSelected, hideActionText, children }) => {
  ...
  return (
    <div 
      ...
      style={{
        ...
        padding: hideActionText ? '12px 14px' : undefined,
        justifyContent: hideActionText ? 'flex-start' : 'space-between'
      }}
    >
